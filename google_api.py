...
def create_service(client_secret_file, api_name, api_version, *scopes, prefix=''):
    """Initilizes Auth2.0 Google Auth app and creates token files"""
    ...
    # Check if token file exists, not the directory again
    ...
    try:
        ...
        os.remove(token_file_path)  # Remove the faulty token file
        return None
